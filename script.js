const circleData = {
  ...
  const senseiData = {
    ...
    intro: `Hi! ayang ada sesuatu didunia kecil buatan aku jangan lupa dijelajahi semua ya`,
    greetings: 'Hi again',
    userProgress: {
      walk: false,
      investigate: false,
    ...
    0: [
      ...
      { 
        ...
        display: {
          ...
          caption: 'there! happy aniv yaa semoga kita selalu tetep bersama! (Hint: look for things with faces)',
        }, 
      },
    ...
    4: [
      ...
      { element: 'cactus', angle: 50, offset: 60, color: 'navy' },
      {
        ...
        display: {
          ...
          caption: `kumpulin point minimal 200 untuk mendapatkan es tongji jgn lupa ss`,
          link: linkButton('https://codepen.io/Yakudoo/pen/YGxYej`)
        },
      },
      {
    ...
    5: [
      ...
      { 
        ...
        display: {
          ...
          link: linkButton('https://wa.me/085609969267', `klik`)
        }, 
      },
      ...
      { 
        ...
        display: { caption: `Hi there, did you notice that  can're actually not moving side ways? The world is moving!` },
      },
    ],
  }
